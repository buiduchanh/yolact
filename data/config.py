...
car_dataset = dataset_base.copy({
    'name': 'Car Dataset',

    'train_images': '/home/ubuntu/only_hanh/dataset/car_segment/coco_car/data_dataset_coco/',
    'train_info':   '/home/ubuntu/only_hanh/dataset/car_segment/coco_car/data_dataset_coco/annotations.json',

    'valid_images': '/home/ubuntu/only_hanh/dataset/car_segment/coco_car/data_dataset_coco/',
    'valid_info':   '/home/ubuntu/only_hanh/dataset/car_segment/coco_car/data_dataset_coco/annotations.json',
...
yolact_base_config = coco_base_config.copy({
    ...
    # Dataset stuff
    'dataset': car_dataset,
    'num_classes': len(car_dataset.class_names) + 1,
